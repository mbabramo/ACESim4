...
namespace ACESim
{
    public static class HyperbolicTangentCurve
    {
        ...
        {
            double yVal = HyperbolicTangentCurve.GetYValueTwoSided(3.0, 3.1, 1.0, 8.0, 2.0, 2.1, 5.0, 5.1, 4.0);
            double xVal = HyperbolicTangentCurve.GetXValueTwoSided(3.0, 3.1, 1.0, 8.0, 2.0, 2.1, 5.0, 5.1, yVal);
            Debug.Assert(Math.Abs(xVal - 4.0) < 0.0001);
            yVal = HyperbolicTangentCurve.GetYValueTwoSided(3.0, 3.1, 1.0, 8.0, 2.0, 2.1, 5.0, 5.1, 2.5);
            xVal = HyperbolicTangentCurve.GetXValueTwoSided(3.0, 3.1, 1.0, 8.0, 2.0, 2.1, 5.0, 5.1, yVal);
            Debug.Assert(Math.Abs(xVal - 2.5) < 0.0001);
            yVal = HyperbolicTangentCurve.GetYValueTwoSided(3.0, 3.1, 11.0, 1.0, -4.0, 7.1, 5.0, 2.1, 3.5);
            xVal = HyperbolicTangentCurve.GetXValueTwoSided(3.0, 3.1, 11.0, 1.0, -4.0, 7.1, 5.0, 2.1, yVal);
            Debug.Assert(Math.Abs(xVal - 3.5) < 0.0001);
            yVal = HyperbolicTangentCurve.GetYValueTwoSided(3.0, 3.1, 11.0, 1.0, -4.0, 7.1, 5.0, 2.1, 2.5);
            xVal = HyperbolicTangentCurve.GetXValueTwoSided(3.0, 3.1, 11.0, 1.0, -4.0, 7.1, 5.0, 2.1, yVal);
            Debug.Assert(Math.Abs(xVal - 2.5) < 0.0001);
        }
    }
