...
computers in the Azure cloud instead of on your local machine, set EvolutionSettings.SaveToAzureBlob to true and then modify the class named cloudpw to use your own Azure credentials. The function should be called GetCloudStorageAccountConnectionString() and should return a string containing valid credentials for an Azure blob account. 
