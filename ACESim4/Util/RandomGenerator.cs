...
namespace ACESim
{
    ...
    public class RandomGeneratorInstanceManager
    {
        ...
        static int arbitrarySeed = 16; // use this to get the same result every time, as long as parallel processing is not enabled and we restart after each evolution
