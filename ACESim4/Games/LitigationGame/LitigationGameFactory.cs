...
namespace ACESim
{
    ...
    [ExportMetadata("GameName", "LitigationGame")] 
    public class LitigationGameFactory : IGameFactory
    {
        /// <summary>
        ...
        {
            return new LitigationGameProgress()  { IterationID = iterationID };
        }
        ...
        {
            return typeof(LitigationGameInputs);
        }
        ...
        {
            return typeof(LitigationGameDefinition);
        }
    }
}
