...
namespace ACESim
{
    ...
    {
        // NOTE: Order: Main players, the resolution player, chance players that may have uneven chance actions (and thus have information sets), then chance players with information sets, then other chance players.
