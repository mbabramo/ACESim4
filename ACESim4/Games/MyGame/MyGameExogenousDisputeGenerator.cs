...
namespace ACESim
{
    public class MyGameExogenousDisputeGenerator : IMyGameDisputeGenerator
    {
        ...
        public void GetActionsSetup(MyGameDefinition myGameDefinition, out byte prePrimaryChanceActions, out byte primaryActions, out byte postPrimaryChanceActions, out byte[] prePrimaryPlayersToInform, out byte[] primaryPlayersToInform, out byte[] postPrimaryPlayersToInform)
        {
        ...
        {
            bool isTrulyLiable = IsTrulyLiable(myGameDefinition, disputeGeneratorActions);
            if (isTrulyLiable)
        ...
        public bool IsTrulyLiable(MyGameDefinition myGameDefinition, MyGameDisputeGeneratorActions disputeGeneratorActions)
        {
