...
namespace ACESim.Util
{
    ...
    public static class RangeFinder
    {
        ...
        public static double CalculatePrecision(double value1, double value2)
        {
            ...
            if (denominator == Single.PositiveInfinity)
            ...
            )
        {
            ...
            double outerBound = initialGuess > center ? Single.PositiveInfinity : Single.NegativeInfinity;
            double guess = initialGuess;
            double guessProportionOfProportionInBounds = proportionOfProportionInBounds(initialGuess);

            double uncertainty = System.Single.MaxValue;
