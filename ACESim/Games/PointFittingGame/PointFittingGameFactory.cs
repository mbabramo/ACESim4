...
namespace ACESim
{
    ...
    [ExportMetadata("GameName", "PointFittingGame")] // put the name of the game class here: ExportMetadata("GameName", "XXX")
    public class PointFittingGameFactory : IGameFactory
    {
        ...
        {
            return new PointFittingGameProgressInfo()  { IterationID = iterationID };
        }
        ...
        {
            return typeof(PointFittingGameInputs);
        }
        ...
        {
            return typeof(PointFittingGameDefinition);
        }
    }
}
