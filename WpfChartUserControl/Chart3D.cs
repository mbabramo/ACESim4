...
namespace WPFChart3D
{
    class Chart3D
    {
        ...
        public void AddAxesMeshes(ArrayList meshs)
        {
            ...
            xAxisCylinder.SetColor(m_xaxisColor);
            ...
            xAxisCone.SetColor(m_xaxisColor);
            ...
            yAxisCylinder.SetColor(m_yaxisColor);
            ...
            yAxisCone.SetColor(m_yaxisColor);
            ...
            zAxisCylinder.SetColor(m_zaxisColor);
            ...
            zAxisCone.SetColor(m_zaxisColor);
        ...
        public Color m_xaxisColor = Color.FromRgb(196, 0, 0);            // axis color (x) -- red
        public Color m_yaxisColor = Color.FromRgb(0, 196, 0);            // axis color (y) -- green
        public Color m_zaxisColor = Color.FromRgb(0, 0, 196);            // axis color (z) -- blue
