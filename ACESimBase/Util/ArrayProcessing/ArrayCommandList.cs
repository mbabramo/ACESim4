...
namespace ACESimBase.Util.ArrayProcessing
{
    public partial class ArrayCommandList
    {
        ...
        public const bool AutogeneratedCodeIsPrecompiled = true; // We can autogenerate and then just save to a c# file, so long as the game structure doesn't change. In that case, we don't need to autogenerate the code.
