...
namespace ACESimBase.Util.ArrayProcessing
{
    public partial class ArrayCommandList
    {
        ...
        public const bool AutogeneratedCodeIsPrecompiled = false; // We can autogenerate and then just save to a c# file, so long as the game structure doesn't change. But we still need to initialize our game tree, since we use it to calculate our ordered sources. In that case, we don't need to autogenerate the code.
    ...
    {{");
            ...
            {
                Console.WriteLine($"Using precompiled code.");
