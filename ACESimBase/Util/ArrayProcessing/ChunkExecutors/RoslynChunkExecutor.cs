...
namespace ACESimBase.Util.ArrayProcessing.ChunkExecutors
{
    ...
    {
        private readonly bool UseCheckpoints;
        ...
        private readonly List<ArrayCommandChunk> Scheduled = new List<ArrayCommandChunk>();
        private Type AutogeneratedCodeType;

        public RoslynChunkExecutor(ArrayCommand[] underlyingCommands, int startIndex, int endIndexExclusive, bool useCheckpoints) : base(underlyingCommands, startIndex, endIndexExclusive)
        {
        ...
        {{
            ...
            foreach (var chunk in Scheduled)
