...
namespace ACESimBase.Util.Collections
{
    ...
    public static class ListExtensions
    {
        ...
        public static List<List<T>> Pivot<T>(this List<List<T>> inputLists, bool removeEmpty, T defaultVal = default)
        {
            if (inputLists == null) throw new ArgumentNullException("inputLists");
            if (removeEmpty && !Equals(defaultVal, default(T))) throw new ArgumentException("You cannot provide a default value and removeEmpty at the same time!", "removeEmpty");
