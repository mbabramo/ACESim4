...
namespace ACESimBase.GameSolvingSupport.Settings
{
    ...
    public class EvolutionSettings
    {
        ...
        public ChunkExecutorKind Unroll_ChunkExecutorKind = ChunkExecutorKind.Interpreted; // DEBUG ILWithLocalVariableRecycling; // Note: RoslynWithLocalVariableRecycling seems to be repeating the same iteration over and over again. 
        ...
        public bool PrintedGameTreeIncludesInformationSetData = true; // set to true to print Tikz diagrams
