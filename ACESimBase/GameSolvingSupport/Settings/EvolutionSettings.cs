...
namespace ACESimBase.GameSolvingSupport.Settings
{
    ...
    public class EvolutionSettings
    {
        ...
        public ChunkExecutorKind Unroll_ChunkExecutorKind = ChunkExecutorKind.IL; // Note: RoslynWithLocalVariableRecycling seems to be repeating the same iteration over and over again. 
