...
namespace ACESimBase.GameSolvingSupport.Settings
{
    ...
    public class EvolutionSettings
    {
        ...
        public bool SkipAltogetherIfEquilibriaFileAlreadyExists = true; // DEBUG // If true, and an equilibrium file exists, then we will skip processing AND reporting. This is useful as a way of just repeating failures.
        ...
        public int SequenceFormNumPriorsToUseToGenerateEquilibria = 50; // Potentially we may end up with this many equilibria, but often different priors lead to the same equilibrium
