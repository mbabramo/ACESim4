...
namespace ACESimBase.GameSolvingSupport.Settings
{
    public abstract class Launcher
    {
        ...
        public static AvailableGames GeneralGameToPlay = AvailableGames.SelectLitigGameCorrSig; // AvailableGames.SelectLitigGameEndog; // Note: More specific game options may be available in the launcher.
