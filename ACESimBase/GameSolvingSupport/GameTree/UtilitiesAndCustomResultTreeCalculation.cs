...
namespace ACESimBase.GameSolvingSupport.GameTree
{
    public class UtilitiesAndCustomResultTreeCalculation : ITreeNodeProcessor<bool, (double[] utilities, FloatSet customResult)>
    {
        ...
        public UtilitiesAndCustomResultTreeCalculation(bool useCurrentStrategy)
        {
            UseCurrentStrategy = useCurrentStrategy;
        }

        public (double[] utilities, FloatSet customResult) ChanceNode_Backward(ChanceNode chanceNode, IEnumerable<(double[] utilities, FloatSet customResult)> fromSuccessors)
        {
        ...
        public (double[] utilities, FloatSet customResult) FinalUtilities_TurnAround(FinalUtilitiesNode finalUtilities, IGameState predecessor, byte predecessorAction, bool fromPredecessor)
        {
