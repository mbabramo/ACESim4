...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public int DeepCFR_BaseReservoirCapacity = 15_000; // the base reservoir capacity -- if generating observations through game progress tree, we multiply this by the number of possible decisions
