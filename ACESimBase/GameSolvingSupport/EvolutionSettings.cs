...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public double Discounting_Gamma_AsPctOfMax(int iteration) => Math.Pow((double)iteration / (double)(iteration + 1), Discounting_Gamma) / Math.Pow((double)TotalVanillaCFRIterations / (double)(TotalVanillaCFRIterations + 1), Discounting_Gamma);
