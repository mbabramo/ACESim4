...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public int SequenceFormNumPriorsToUseToGenerateEquilibria = 5_000; // Potentially we may end up with this many equilibria, but often different priors lead to the same equilibrium
