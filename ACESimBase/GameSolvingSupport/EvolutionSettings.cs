...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public int SequenceFormNumPriorsToUseToGenerateEquilibria = 25; // Potentially we may end up with this many equilibria, but often different priors lead to the same equilibrium
