...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public bool DeepCFR_ApproximateBestResponse_BackwardInduction = false;
        public int DeepCFR_ApproximateBestResponseIterations = 4; // if not using backward induction
