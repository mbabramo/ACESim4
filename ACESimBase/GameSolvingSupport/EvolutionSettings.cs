...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public int SequenceFormNumPriorsToUseToGenerateEquilibria = 50; // DEBUG // Potentially we may end up with this many equilibria, but often different priors lead to the same equilibrium
