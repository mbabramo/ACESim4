...
namespace ACESim
{
    ...
    public class EvolutionSettings
    {
        ...
        public bool DiscountRegrets = false; // if true, Discounting_Alpha and Discounting_Beta are used -- note never currently used in HedgeVanilla
        ...
        public bool UnrollAlgorithm = false;  // DEBUG -- MUST remove debug in HedgeVanilla before using Unrolled.
    }
}
