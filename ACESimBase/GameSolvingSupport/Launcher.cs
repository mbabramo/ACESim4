...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public const int VanillaIterations = 10; // DEBUG
        public const int VanillaReportEveryNIterations = VanillaIterations;
        public const int VanillaBestResponseEveryMIterations = 500; // DEBUG VanillaIterations; // DEBUG EffectivelyNever; 
        ...
        public string MasterReportNameForDistributedProcessing = "R133"; // IMPORTANT: Must update this (or delete the Coordinator) when deploying service fabric
