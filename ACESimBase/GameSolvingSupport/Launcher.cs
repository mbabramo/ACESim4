...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public int[] LimitToTaskIDs = null; // new int[] { 1100, 1102, 1119, 1150, 1152, 1169, 1200, 1201, 1202, 1204, 1205, 1206, 1207, 1208, 1209, 1210, 1212, 1213, 1214, 1215, 1216, 1217, 1219, 1220, 1221, 1222, 1223, 1224, 1225, 1226 }; // set this to non-null to repeat specific IDs (e.g., from failures) from a distributed action set.
