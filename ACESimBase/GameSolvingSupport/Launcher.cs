...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public const int VanillaIterations = 5; // Note: Also used for GeneralizedVanilla, DeepCFR
        public const int VanillaReportEveryNIterations = VanillaIterations;
        public const int VanillaBestResponseEveryMIterations = VanillaIterations; // EffectivelyNever; 
        ...
        public const int SummaryTableRandomPathsIterations = 1_000_000;
