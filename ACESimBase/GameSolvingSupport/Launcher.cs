...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public const int SummaryTableRandomPathsIterations = 25_000; // DEBUG
        ...
        public string MasterReportNameForDistributedProcessing = "R080"; // IMPORTANT: Must update this (or delete the Coordinator) when deploying service fabric
