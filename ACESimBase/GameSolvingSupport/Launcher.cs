...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public const int VanillaReportEveryNIterations = 100; // DEBUG EffectivelyNever;
        ...
        public const int SummaryTableRandomPathsIterations = 10_000; // DEBUG
        ...
        public string MasterReportNameForDistributedProcessing = "R079"; // IMPORTANT: Must update this (or delete the Coordinator) when deploying service fabric
