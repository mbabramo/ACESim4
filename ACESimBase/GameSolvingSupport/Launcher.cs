...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public const int VanillaBestResponseEveryMIterations = 10; // DEBUG
        ...
        public bool ParallelizeIndividualExecutions = false; // DEBUG SUPERDEBUG // only if !ParallelizeOptionSets && (LaunchSingleOptionsSetOnly || !DistributedProcessing)
