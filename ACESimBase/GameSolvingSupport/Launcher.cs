...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public const int VanillaIterations = 550; // Note: Also used for GeneralizedVanilla, DeepCFR
        public const int VanillaReportEveryNIterations = VanillaIterations; // VanillaIterations; // EffectivelyNever
        public int? SuppressReportBeforeIteration = null;
        public const int VanillaBestResponseEveryMIterations = 25; // VanillaIterations; // DEBUG
