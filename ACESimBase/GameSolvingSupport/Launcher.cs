...
namespace ACESim
{
    public abstract class Launcher
    {
        ...
        public string MasterReportNameForDistributedProcessing = "R358"; // ******* IMPORTANT: (1) Delete bin/obj in AceSimDistributed before building. (2) Must update this (or delete the Coordinator) when deploying service fabric. 
