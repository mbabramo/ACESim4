    ...
    public partial class DeepCFR : CounterfactualRegretMinimization
    {
        ...
        private async Task BuildModelPredictingUtilitiesBasedOnPrincipalComponents()
        {
            if (EvolutionSettings.PCA_BuildModelToPredictUtilitiesBasedOnPrincipalComponents)
            {
                ...
                int numGamesToPlayToEstimateEachUtilityWhileBuildingModel = EvolutionSettings.PCA_NumGamesToPlayToEstimateEachUtilityWhileBuildingModel;
        ...
        public PrincipalComponentsAnalysis PerformPrincipalComponentAnalysis(byte playerIndex)
        {
            ...
            PrincipalComponentsAnalysis stats = new PrincipalComponentsAnalysis(originalGenotypes, EvolutionSettings.PCA_NumPrincipalComponents, EvolutionSettings.PCA_Precision);
            return stats;
        }
