...
namespace ACESim
{
    ...
    public class MultiRoundCooperationGameFactory : IGameFactory
    {
        ...
        {
            return new MultiRoundCooperationGame(strategies, progress, gameDefinition, recordReportInfo, restartFromBeginningOfGame);
        }
        ...
        {
            GameProgress gameProgress = new MultiRoundCooperationGameProgress()  { IterationID = iterationID };
            return gameProgress;
        }
