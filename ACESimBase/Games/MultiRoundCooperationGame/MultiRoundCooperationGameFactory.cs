...
{
    [Serializable]
    public class MultiRoundCooperationGameFactory : IGameFactory
    {
        /// <summary>
        ...
        {
            return new MultiRoundCooperationGame(strategies, progress, gameDefinition, recordReportInfo, restartFromBeginningOfGame, fullHistoryRequired);
        }
        ...
        {
            GameProgress gameProgress = new MultiRoundCooperationGameProgress(fullHistoryRequired)  { IterationID = iterationID };
            return gameProgress;
        }
        ...
        {
            return typeof(MultiRoundCooperationGameDefinition);
        }
    }
}
