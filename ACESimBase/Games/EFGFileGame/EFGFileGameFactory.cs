...
namespace ACESimBase.Games.EFGFileGame
{
    ...
    public class EFGFileGameFactory : IGameFactory
    {
        /// <summary>
        ...
        {
            return new EFGFileGame(strategies, progress, gameDefinition, recordReportInfo, restartFromBeginningOfGame, fullHistoryRequired);
        }
        ...
        {
            GameProgress gameProgress = new EFGFileGameProgress(fullHistoryRequired) { IterationID = iterationID };
            return gameProgress;
        }
        ...
        {
            return typeof(EFGFileGameDefinition);
        }
    }
}