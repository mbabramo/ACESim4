...
namespace ACESim
{
    ...
    public class SimpleGameDefinition : GameDefinition
    {
        ...
        private List<Decision> GetDecisionsList()
        {
            ...
            {
                new Decision("P1", "P1", false, (byte)SimpleGamePlayers.Player1, P1InformsP2 ? playersWithP1Informing.ToArray() : playersToInform.ToArray(), 2, (byte)SimpleGameDecisions.P1Decision),
                new Decision("P2", "P2", false, (byte)SimpleGamePlayers.Player2, playersToInform.ToArray(), 2, (byte)SimpleGameDecisions.P2Decision),
                new Decision("C", "C", true, (byte)SimpleGamePlayers.Chance, playersToInform.ToArray(), 2, (byte)SimpleGameDecisions.Chance, unevenChanceActions: true) { CanTerminateGame = true }
            };
            return decisions;
        }
