...
namespace ACESim
{
    public static class MyGameRunner
    {
        ...
        private const int VanillaIterations = 20000; // DEBUG
        private const int VanillaReportEveryNIterations = 20000;
        private const int VanillaBestResponseEveryMIterations = 5000; 
