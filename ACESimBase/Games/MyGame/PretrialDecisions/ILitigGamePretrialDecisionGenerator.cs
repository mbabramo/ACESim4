...
namespace ACESim
{
    public interface ILitigGamePretrialDecisionGenerator
    {
        ...
        void GetEffectOnPlayerWelfare(LitigGameDefinition myGameDefinition, bool trialOccurs, bool pWinsAtTrial, double damagesAlleged, LitigGamePretrialActions pretrialActions, out double effectOnP, out double effectOnD);
