...
namespace ACESim
{
    public interface IMyGamePretrialDecisionGenerator
    {
        ...
        void GetEffectOnPlayerWelfare(MyGameDefinition myGameDefinition, bool trialOccurs, bool pWinsAtTrial, double damagesAwarded, MyGamePretrialActions pretrialActions, out double effectOnP, out double effectOnD);
