...
namespace ACESim
{
    ...
    public partial class MyGameDefinition : GameDefinition
    {
        ...
        public override int NumWarmupOptionSets => 20; // Note that this can be 0
        ...
        public override int NumDifferentWeightsOnOpponentsStrategyPerWarmupScenario_IfMultiplyingScenarios => 20; // should be odd if we want to include zero
