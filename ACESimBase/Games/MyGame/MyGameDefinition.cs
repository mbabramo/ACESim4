...
namespace ACESim
{
    ...
    public partial class MyGameDefinition : GameDefinition
    {
        ...
        public override bool PlayMultipleScenarios => false; // DEBUG // Note: Even if this is false, we can define a scenario as a "warm-up scenario."

        public override int NumPostWarmupOptionSets => 1; 
        public override int NumWarmupOptionSets => 3; // Note that this can be 0. This indicates the variations on the costs multiplier; variations on weight to opponent are below. 
