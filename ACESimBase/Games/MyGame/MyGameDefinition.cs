...
namespace ACESim
{
    ...
    public partial class MyGameDefinition : GameDefinition
    {
        ...
        public override int NumWarmupOptionSets => 10; // Note that this can be 0. This indicates the variations on the costs multiplier; variations on weight to opponent are below. 
