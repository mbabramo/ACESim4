    ...
    public static class LeducGameRunner
    {
        ...
        private static EvolutionSettings GetEvolutionSettings()
        {
            EvolutionSettings evolutionSettings = new EvolutionSettings()
            {
                ...
                ParallelOptimization = false, // ParallelizeIndividualExecutions && !ParallelizeOptionSets && !LocalDistributedProcessing,
                ...
                PrintGameTree = false,
                ActionStrategiesToUseInReporting = new List<ActionStrategies>() { ActionStrategies.AverageStrategy },
        ...
        public static async Task<string> EvolveLeducGame()
        {
            string result;
            if (SingleGameMode)
                result = await EvolveLeducGame_Single();
            else
        ...
        public static async Task<string> EvolveLeducGame_Single()
        {
            var options = new LeducGameOptions() { OneBetSizeOnly = OneBetSizeOnly };
            string report = await ProcessSingleOptionSet(options, "Report", "Single", true);
            return report;
        }
        ...
        private static async Task<string> ProcessSingleOptionSet(LeducGameOptions options, string masterReportName, string optionSetName, bool includeFirstLine)
        {
        ...
        public static async Task<string> GetSingleRepetitionReportAndSave(string masterReportName, LeducGameOptions options, string optionSetName, int repetition, CounterfactualRegretMinimization developer)
        {
            string masterReportNamePlusOptionSet = $"{masterReportName} {optionSetName}";
            if (developer == null)
