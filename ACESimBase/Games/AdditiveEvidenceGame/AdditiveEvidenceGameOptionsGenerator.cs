...
namespace ACESimBase.Games.AdditiveEvidenceGame
{
    public class AdditiveEvidenceGameOptionsGenerator
    {
        ...
        public static byte NumOffers = 5; // DEBUG 25; // having a good number here allows for more precise strategies
        public static byte NumQualityAndBiasLevels_PrivateInfo = 5; // DEBUG 10; // we don't need quite as much here, since it's information that doesn't intersect between players
        public static byte NumQualityAndBiasLevels_NeitherInfo = 5; // DEBUG 10; // still less needed here
