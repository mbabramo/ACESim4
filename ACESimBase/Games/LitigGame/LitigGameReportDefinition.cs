    ...
    public partial class LitigGameDefinition
    {
        ...
        private SimpleReportDefinition GetOverallReport()
        {
            ...
            colItems.AddRange(new List<SimpleReportColumnItem>()
            {
                ...
                new SimpleReportColumnVariable("TotWealth", (GameProgress gp) => MyGP(gp).PFinalWealth + MyGP(gp).DFinalWealth),
                new SimpleReportColumnVariable("WealthLoss", (GameProgress gp) => MyGP(gp).LitigGameDefinition.Options.PInitialWealth + MyGP(gp).LitigGameDefinition.Options.DInitialWealth - MyGP(gp).PFinalWealth - MyGP(gp).DFinalWealth),
                new SimpleReportColumnVariable("PWelfare", (GameProgress gp) => MyGP(gp).PWelfare),
                new SimpleReportColumnVariable("DWelfare", (GameProgress gp) => MyGP(gp).DWelfare),
                ...
                new SimpleReportColumnVariable("False+-", (GameProgress gp) => MyGP(gp).FalsePositiveExpenditures + MyGP(gp).FalseNegativeShortfall),
                new SimpleReportColumnVariable("False+^2", (GameProgress gp) => MyGP(gp).FalsePositiveExpenditures * MyGP(gp).FalsePositiveExpenditures),
                new SimpleReportColumnVariable("False-^2", (GameProgress gp) => MyGP(gp).FalseNegativeShortfall * MyGP(gp).FalseNegativeShortfall),
                new SimpleReportColumnVariable("PDSWelfareLoss", (GameProgress gp) => -MyGP(gp).PreDisputeSharedWelfare),
                ...
                new SimpleReportColumnVariable("OpportunityCost", (GameProgress gp) => -MyGP(gp).OpportunityCost + MyGP(gp).TotalExpensesIncurred),
                new SimpleReportColumnVariable("HarmCost", (GameProgress gp) => -MyGP(gp).HarmCost + MyGP(gp).TotalExpensesIncurred),
