...
namespace ACESim
{
    public class LitigGameLauncher : Launcher
    {
        ...
        public override string MasterReportNameForDistributedProcessing => "FS007"; // ******* IMPORTANT: (1) Delete bin/obj in AceSimDistributed. Make sure that the correct Launcher is set in ACESimDistributed Program.cs. (2) Must update this (or delete the Coordinator) when deploying service fabric. 
