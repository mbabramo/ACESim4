...
/// <summary>The article's deliberately arranged worked-path figure. LaTeX is an output.</summary>
public static class WorkedPathDiagram
{
    public const string FileStem = "worked equilibrium path";

    public static string Generate(ArticleWorkedPathExtraction.Extraction data) =>
        Layout.Replace("% INSERT_EXTRACTED_VALUES", ArticleWorkedPathLatexData.Build(data)) + "\n";
